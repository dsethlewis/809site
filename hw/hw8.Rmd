...
To implement the first-difference approach, I relied on Equation 2 in @liker1985ssr:
...
To understand the relationships among the four variables implicitly embedded in the first-difference model, we could use a similar approach to that presented by @edwards2002maabioaimada: a regression equation with the difference-scored variables pulled apart into their component parts. However, because we are also using a difference-scored variable as a dependent variable, we would need to use a multivariate regression method, like CCA or MMR [@thompson1991m&eic&d; @dwyer1983smftsabs].

## B. Static-Score Model

To develop a static-score model for the data, I relied on Equation 2.5 from [-@finkel1995]:
...
Second, PSDE positively and significantly predicts FSDE at all time periods, suggesting that 
